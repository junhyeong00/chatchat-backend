...
public class CompanyChatRoomController {
    private final GetCompanyChatRoomsService getChatRoomsService;
    private final GetCompanyChatRoomService getChatRoomService;

    public CompanyChatRoomController(GetCompanyChatRoomsService getChatRoomsService,
                                     GetCompanyChatRoomService getChatRoomService) {
